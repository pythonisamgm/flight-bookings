...
public class UserEntity implements UserDetails {
     ...
     */
    public UserEntity(Long id, String username, String password, String email, ERole role, List<BookingEntity> bookings) {
        this.userId = id;
    ...
    public static class Builder {
         ...
         * @return The current Builder instance.
         */
        public Builder bookings(List<BookingEntity> bookings) {
            this.bookings = bookings;
            return this;
        }
        ...
        public UserEntity build() {
            return new UserEntity(userId, username, password, email, role, bookings);
        }
    }
}