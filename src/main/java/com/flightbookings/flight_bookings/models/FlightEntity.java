...
public class FlightEntity {
    ...
    public FlightEntity(Long flightId, int flightNumber, int numRows, LocalDateTime departureTime, LocalDateTime arrivalTime, Duration flightDuration, EFlightAirplane flightAirplane, int capacityPlane, boolean availability, BigDecimal flightPrice, List<SeatEntity> seats, List<BookingEntity> bookingList, String originAirport, String destinationAirport) {
